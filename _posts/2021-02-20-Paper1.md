...
The permanent link via DOI number of the paper is [HERE](https://www.researchgate.net/publication/349895571_Multi-scale_seismic_reliability_assessment_of_networks_by_centrality-based_selective_recursive_decomposition_algorithm). The full reference information is as follows.

<hr>

> Lee, D., & Song, J. (2021). [Multi-scale seismic reliability assessment of networks by centrality-based selective recursive decomposition algorithm](https://www.researchgate.net/publication/349895571_Multi-scale_seismic_reliability_assessment_of_networks_by_centrality-based_selective_recursive_decomposition_algorithm). _Earthquake Engineering & Structural Dynamics_. Vol. 50, 2174-2194.
