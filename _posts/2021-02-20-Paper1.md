...
The permanent link via DOI number of the paper is https://doi.org/10.1002/eqe.3447. The full reference information is as follows.

<hr>

> Lee, D., & Song, J. (2021). Multi-scale seismic reliability assessment of networks by centrality-based selective recursive decomposition algorithm. _Earthquake Engineering and Structural Dynamics_. Vol. 50, 2174-2194.
...
<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/news/news8_1.png" class="img-fluid rounded z-depth-1" %}</swiper-slide>
