...
Through the support by Seoul National University, the paper was published as an Open Access article, and thus downloadable for free. The permanent link via DOI number of the paper is [HERE](https://doi.org/10.1002/eqe.4362). The full reference information is as follows.

<hr>

> Lee, D., Byun, J.E., & Song, J. (2025). [Dual graph-based Bayesian network modeling with Rao-Blackwellization for seismic reliability and complexity quantification of network connectivity](https://doi.org/10.1002/eqe.4362). _Earthquake Engineering & Structural Dynamics_, In Press.
