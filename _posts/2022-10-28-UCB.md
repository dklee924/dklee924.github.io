...
As a first step, we have developed a new advanced sampling-based method for reliability analysis of complex infrastructure networks {% cite lee2025efficient %}. The permanent link via DOI number of the paper is [{% cite lee2025efficient %}](https://doi.org/10.1016/j.ress.2025.110947). The full reference information is as follows.
